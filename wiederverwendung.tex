...
Des weiteren kann davon ausgegangen werden, das bereits exisitierende Softwarekomponenten eine höhere Zuverlässigkeit besitzen, da Fehler die evtl im Entwurf oder der Implementierung durch den bereits stattgefundenen Einsatz aufgefallen und behoben sind. Dadurch wird implizit die Qualität der neu entwickelten Software erhöht.    
...
\begin{description}
	\item[Software Reuse, \autocite{Kru92}] \enquote{ Software reuse is the process ofcreating software systems from existing software
...
Die Wiederverwendung von Software ist seit beginn der Softwareentwicklung ein zentrales Thema. Der Begriff wurde erstmals von McIlroy 1968 geprägt. Er beschreibt in [] die damals katastrophale Lage der Softwareentwicklung und die Wiederverwendung als möglichen Ausweg aus der Softwarekrise.
