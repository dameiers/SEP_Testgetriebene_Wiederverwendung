...
\begin{itemize}
	...
	\item In dem Fenster mit den Details zur Suche kann der Benutzer sich das Outline der gefundenen Komponenten anschauen, sowie den Quellcode überprüfen.
	\item Hat sich der Benutzer für eine Komponenten entschieden, kann er diese zu seinem Projekt hinzufügen, wobei Code Conjurer die Abhängigkeiten automatisch auflöst.
\end{itemize}
